    ...
    <div className={styles.container}>
      ...
      <div className={styles.intro}>
        <div className={styles.introSubContainer}>
          ...
          <div className={styles.introTagline}>
            I'm Robert! Not sure what to write here...
          </div>
          <span className={styles.introEmail}>Want to talk? -> </span>
      ...
      <div className={styles.background}>
        ...
        <p className={styles.backgroundTextContainer}>
          I am currently a student at The University of Melbourne studying
          Computing and Software. I love going to Hackathons and talking about
          tech!
        </p>
      </div>
      {/* Project Section */}
      <div className={styles.projects}>
        ...
        <div className={styles.projectsTable}>
          <ProjectCells
            ...
            Developed on React Native (Expo) and Firebase."
          />
          <ProjectCells
            title="Catalyst Hack"
            date="Nov 2018"
          ...
          <ProjectCells
            ...
            returning home late at night. Developed on the Android platform using Java and Firebase. "
          />
        </div>
