      ...
      <Layout>
        <div className={styles.container}>
          <Form className={styles.form}>
            ...
            <FormGroup>
              <Label for="name" className={styles.labelText}>
                Name
              </Label>
              <Input
                type="text"
            ...
            <FormGroup>
              <Label for="email" className={styles.labelText}>
                Email
              </Label>
              <Input
                type="email"
            ...
            <FormGroup>
              <Label for="subject" className={styles.labelText}>
                Subject
              </Label>
              <Input
                type="text"
            ...
            <FormGroup>
              <Label for="message" className={styles.labelText}>
                Message
              </Label>
              <Input
                type="textarea"
